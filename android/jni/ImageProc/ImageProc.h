...
int Java_org_x3f_autobot_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_org_x3f_autobot_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
